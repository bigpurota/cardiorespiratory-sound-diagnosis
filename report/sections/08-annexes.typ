...
_Heart-sound class distribution_ (@fig-eda-class-heart): the CinC 2016 training
...
_Heart recordings per database_ (@fig-eda-db): database A (community settings) is
